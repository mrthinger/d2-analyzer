...
from ...models.player_win_loss_response import PlayerWinLossResponse
...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "/players/{account_id}/wl".format(
...
) -> Optional[PlayerWinLossResponse]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PlayerWinLossResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PlayerWinLossResponse]:
    return Response(
