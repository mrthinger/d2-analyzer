...
from ...models.player_heroes_response import PlayerHeroesResponse
...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "/players/{account_id}/heroes".format(
...
) -> Optional[List["PlayerHeroesResponse"]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = PlayerHeroesResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[List["PlayerHeroesResponse"]]:
    return Response(
