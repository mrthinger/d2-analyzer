...
from ...models.player_word_cloud_response import PlayerWordCloudResponse
...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "/players/{account_id}/wordcloud".format(
...
) -> Optional[PlayerWordCloudResponse]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PlayerWordCloudResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PlayerWordCloudResponse]:
    return Response(
