...
from ...models.player_totals_response import PlayerTotalsResponse
...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "/players/{account_id}/totals".format(
...
) -> Optional[List["PlayerTotalsResponse"]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = PlayerTotalsResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[List["PlayerTotalsResponse"]]:
    return Response(
