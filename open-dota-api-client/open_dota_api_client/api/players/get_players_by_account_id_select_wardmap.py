...
from ...models.player_ward_map_response import PlayerWardMapResponse
...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "/players/{account_id}/wardmap".format(
...
) -> Optional[PlayerWardMapResponse]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PlayerWardMapResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PlayerWardMapResponse]:
    return Response(
