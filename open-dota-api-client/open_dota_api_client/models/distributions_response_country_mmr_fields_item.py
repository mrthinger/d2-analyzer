...
T = TypeVar("T", bound="DistributionsResponseCountryMmrFieldsItem")


@_attrs_define
class DistributionsResponseCountryMmrFieldsItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        distributions_response_country_mmr_fields_item = cls(
            name=name,
            table_id=table_id,
            column_id=column_id,
        ...
        distributions_response_country_mmr_fields_item.additional_properties = d
        return distributions_response_country_mmr_fields_item
