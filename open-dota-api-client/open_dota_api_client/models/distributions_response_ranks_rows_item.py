...
T = TypeVar("T", bound="DistributionsResponseRanksRowsItem")


@_attrs_define
class DistributionsResponseRanksRowsItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        distributions_response_ranks_rows_item = cls(
            bin_=bin_,
            bin_name=bin_name,
            count=count,
        ...
        distributions_response_ranks_rows_item.additional_properties = d
        return distributions_response_ranks_rows_item
