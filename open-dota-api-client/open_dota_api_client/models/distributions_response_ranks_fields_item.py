...
T = TypeVar("T", bound="DistributionsResponseRanksFieldsItem")


@_attrs_define
class DistributionsResponseRanksFieldsItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        distributions_response_ranks_fields_item = cls(
            name=name,
            table_id=table_id,
            column_id=column_id,
        ...
        distributions_response_ranks_fields_item.additional_properties = d
        return distributions_response_ranks_fields_item
